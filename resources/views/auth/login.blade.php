<html lang="en"><!--begin::Head--><head>
        ...
        <link href="{{asset('control/style/assets/css/pages/login/login-3.css?v=7.0.8')}}" rel="stylesheet" type="text/css">
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable" cz-shortcut-listen="true">
                ...
                <div class="login-aside d-flex flex-column flex-row-auto">
                    ...
                    <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                        ...
                        <a href="#" class="login-logo text-center pt-lg-25 pb-10">
                            <img src="{{asset('control/style/assets/media/logos/logo_eraders.png')}}" class="max-h-70px" alt="">
                        </a>
                        <!--end::Aside header-->
                        <!--begin::Aside Title-->
                        <h3 class="font-weight-bolder text-center font-size-h4 text-dark-50 line-height-xl">Enjoy Our Online Platform
                        <br>For Books Services</h3>
                        <!--end::Aside Title-->
                    </div>
                    <!--end::Aside Top-->
                    <!--begin::Aside Bottom-->
                    <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100% + 5rem); background-image: url({{asset('control/style/assets/media/svg/illustrations/login-visual-5.svg')}}"></div>
                    <!--end::Aside Bottom-->
                </div>
                <!--begin::Aside-->
                <!--begin::Content-->
                <div class="login-content flex-row-fluid d-flex flex-column p-10">
                    ...
                    <div class="d-flex flex-row-fluid flex-center">
                        ...
                        <div class="login-form">
                            <!--begin::Form-->
                            <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_singin_form" action="{{route('login')}}" method="POST" novalidate="novalidate">
                                @csrf
                                <!--begin::Title-->
                                <div class="pb-5 pb-lg-15">
                                    <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Sign In</h3>
                                    <div class="text-muted font-weight-bold font-size-h4">New Here? 
                                    <a href="/metronic/demo1/custom/pages/login/login-3/signup.html" class="text-primary font-weight-bolder">Create Account</a></div>
                                </div>
                                <!--begin::Title-->
                                <!--begin::Form group-->
        ...
        <script src="{{asset('control/style/assets/plugins/global/plugins.bundle.js?v=7.0.8')}}"></script>
        <script src="{{asset('control/style/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.8')}}"></script>
        <script src="{{asset('control/style/assets/js/scripts.bundle.js?v=7.0.8')}}"></script>
        <!--end::Global Theme Bundle-->
        <!--begin::Page Scripts(used by this page)-->
        {{-- <script src="{{asset('control/style/assets/js/pages/custom/login/login-3.js?v=7.0.8')}}"></script> --}}
        <!--end::Page Scripts-->
