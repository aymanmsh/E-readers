			...
			<div class="card-body">
				<form action="{{ route('library.update', ['id' => $library->id])}}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row" style="text-align: center;">
						<label class="col-xl-12 col-lg-12 col-form-label text-center">Category Image</label>
						<div class="col-lg-12 col-xl-12">
							<div class="image-input image-input-outline" id="kt_image_1">
								<div class="image-input-wrapper" style="background-image: url('{{$library->getImage()}}');"></div>
					...
					<div class="form-group">
						...
						<input type="text" name="name" class="form-control" value="{{$library['name']}}" placeholder="Library Name">
					...
					<div class="form-group">
						<label>Email
						<span class="text-danger">*</span></label>
						<input type="text" name="email" class="form-control" value="{{$library['email']}}" placeholder="Email Address">
					...
					<div class="form-group">
						<label>Phone
						<span class="text-danger">*</span></label>
						<input type="text" name="phone" class="form-control" value="{{$library['phone']}}" placeholder="Phone Number">
