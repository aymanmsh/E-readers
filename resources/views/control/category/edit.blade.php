			...
			<div class="card-body">
				<form action="{{ route('category.update', ['id' => $category->id])}}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row" style="text-align: center;">
						...
						<div class="col-lg-12 col-xl-12">
							<div class="image-input image-input-outline" id="kt_image_1">
								<div class="image-input-wrapper" style="background-image: url('{{$category->getImage()}}');"></div>
					...
					<div class="form-group">
						...
						<input type="text" name="name" class="form-control" value="{{$category['name']}}" placeholder="{{trans('categories.view.category_name')}}">
					...
					<div class="form-group">
						...
						<select class="form-control" name="lang">
							<option value="en" {{$category['name'] == 'en' ? 'selected' : '' }}>English</option>
							<option value="ar" {{$category['name'] == 'ar' ? 'selected' : '' }}>Arabic</option>
						</select>
