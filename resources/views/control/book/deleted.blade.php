				    ...
				    <tbody>
				        ...
				        @foreach( $books as $book )
				        	<tr>
				        		...
				        		<td class="settings">
				        			<a class="btn btn-primary" href="{{route('book.edit', ['id' => $book->id])}}"><i class="fa fa-check"></i></a>
				        			<a class="btn btn-danger restore-book" data-id="{{$book->id}}"><i class="fa fa-trash"></i></a>
				        		</td>
				        	</tr>
						@endforeach				       				    	
				    </tbody>
...
@section('script')
	...
	<script type="text/javascript">
		$('.restore-book').on('click', function(event) {
		...
		if (result.value) {
			window.location = '{{route("book.restore")}}/' + id
			Swal.fire(
				'Deleted!',
